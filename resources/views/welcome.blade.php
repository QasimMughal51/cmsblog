            ...
            <div class="col-lg-8">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                    ...
                    <div class="post-thumb">
                        <img src="{{$first_post->getFeatured()}}" alt="seo">
                        <div class="overlay"></div>
                        <a href="{{$first_post->getFeatured()}}" class="link-image js-zoom-image">
        ...
        <div class="row">
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                    ...
                    <div class="post-thumb">
                        <img src="{{$second_post->getFeatured()}}" alt="seo">
                        <div class="overlay"></div>
                        <a href="{{$second_post->getFeatured()}}" class="link-image js-zoom-image">
                            <i class="seoicon-zoom"></i>
                        </a>
                        <a href="#" class="link-post">
                            <i class="seoicon-link-bold"></i>
            ...
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                    ...
                    <div class="post-thumb">
                        <img src="{{$third_post->getFeatured()}}" alt="seo">
                        <div class="overlay"></div>
                        <a href="{{$third_post->getFeatured()}}" class="link-image js-zoom-image">
                            <i class="seoicon-zoom"></i>
                        </a>
                        <a href="#" class="link-post">
                            <i class="seoicon-link-bold"></i>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="case-item">
                                        <div class="case-item__thumb">
                                            <img src="{{$post->getFeatured()}}" alt="our case">
                                        </div>
