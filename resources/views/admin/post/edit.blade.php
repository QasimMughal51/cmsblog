        ...
        <div class="body">
            <form action="{{route('post.update',['id'=>$post->id])}}" method="Post" enctype="multipart/form-data">
                ...
                <div class="form-group  checkbox-inline ">
                    ...
                    @foreach($tags as $tag)
                        <div class="checkbox  ">
                            <lable><input type="checkbox" name="tags[]" value="{{$tag->id}}"
                ...
                <div class="form-gorup">
                    ...
                    <textarea name="post_content" id="summernote" class="form-control" placeholder="Enter Post Content" cols="30" rows="10">{{$post->content}}</textarea>
                </div>
